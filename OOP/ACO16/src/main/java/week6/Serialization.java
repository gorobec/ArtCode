...
public class Serialization {
    public static void main(String[] args) {
        ...
        try {
            ObjectOutputStream oos = new ObjectOutputStream(
                    new BufferedOutputStream(
                            new FileOutputStream("/home/gorobec/java/development/Teaching/ArtCode/OOP/ACO16/src/main/recources/dir1/univercity.txt")));

            oos.writeObject(artCode);
            oos.flush();

            ObjectInputStream ois = new ObjectInputStream(
                    new BufferedInputStream(
                            new FileInputStream("/home/gorobec/java/development/Teaching/ArtCode/OOP/ACO16/src/main/recources/dir1/univercity.txt")));



            clone = (University) ois.readObject();
        ...
        System.out.println(artCode.hashCode());
    }
}

...
public class _6GridBagLayoutTest extends JFrame {

    public _6GridBagLayoutTest() {
        super("GridBagLayout");
        final JPanel content = new JPanel(new GridBagLayout());
        JLabel lblImage = new JLabel(new ImageIcon(getClass().getResource("/week8/examples/Crystal_128_penguin.png")));
    ...
    public static void main(String[] args) {
        ...
        new _6GridBagLayoutTest().setVisible(true);
    }
}